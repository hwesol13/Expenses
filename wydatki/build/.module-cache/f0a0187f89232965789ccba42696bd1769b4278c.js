...
function enterPressed() { //po wcisnieciu enter gry kursor znajduje sie w polu tekstowym wywoluje funkcje AddNewItem(). wywolana po wczytaniu komponentu React poniewaz odwoluje sie do ID komponentow.
...
var ItemsList = React.createClass({displayName: "ItemsList",	//towrzy nowa klase ItemsList
	...
	return (
			React.createElement("div", null, 
				React.createElement("div", {id: "inputFields"}, 
					React.createElement("h2", null, "Wydatki"), 
					React.createElement("input", {type: "text", id: "descriptionInput", placeholder: "Opis..."}), 
					React.createElement("input", {type: "text", id: "valueInput", placeholder: "Wartosc w PLN", onKeyUp: this.validateInput})
				), 
				React.createElement("div", {className: "autocenter"}, 
					React.createElement("ul", null, 
						React.createElement(List, {items: this.state.items, sum: this.state.sum, id: ""})
					), 
					React.createElement("p", {id: "pSuma"}, "Suma: " + this.state.sum.sum + " zł")
				)
			)
			)		
	}
...
var List = React.createClass({displayName: "List",	// tutaj przygotowuja sie elementy listy dla komponentu powyzej. przekazywane sa stany items i sum a potem mapowane do elementu li.
	...
	render: function() {
		...
		React.createElement("div", null, 
			...
			this.props.items.map(function(item) {
				return (React.createElement("div", {id: "liElement", key: item.key}, React.createElement("li", {className: "leftElement"}, item.date), React.createElement("li", {className: "middleElement"}, item.description), React.createElement("li", {className: "rightElement"}, item.value + " zł", React.createElement("img", {id: "img", src: "images/zamknij.png", onClick: this.handleClick.bind(this, item.key)}))))
			}.bind(this))
...
React.render(React.createElement(ItemsList, null), document.body) //wczytanie komponentu do DOM
